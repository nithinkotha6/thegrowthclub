...
export async function POST(req: Request) {
  try {
    ...
    // ── 3. Asynchronous Background Decoupled Execution ──────────────────────
    after(async () => {
      try {
        console.log('[webhook/whatsapp] Background processing started via after()');
        ...
        console.error('[webhook/whatsapp] Background cron processing crashed:', bgError);
    ...
    // Return 200 OK to Green API immediately
